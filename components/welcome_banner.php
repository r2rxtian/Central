...
<section class="hero-banner">
  ...
  <!-- 3. Soft Transition Zone Scripted Text ("Exceptional Indulgence Together") -->
  <div class="hero-script-zone">
    <div class="hero-script-text">
      <span class="hero-script-line1">Exceptional</span>
      <span class="hero-script-line2">Indulgence</span>
      <span class="hero-script-line3">Together</span>
    </div>
  ...
  <div class="hero-content">
    <div class="hero-text-block">
      <div class="hero-overline">GOOD MORNING,</div>
